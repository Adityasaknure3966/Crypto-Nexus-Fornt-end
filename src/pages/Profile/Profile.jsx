            ...
            <div className="lg:flex gap-32">
              <div className="space-y-7">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"Aditya Saknure"} </p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">Date Of Birth : </p>
                  <p className="text-gray-500">{"01/10/2002"} </p>
                </div>
                <div className="flex">
              ...
              <div className="space-y-7">
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"Profounnd"} </p>
                </div>
                <div className="flex">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{411038} </p>
                </div>
                <div className="flex">
